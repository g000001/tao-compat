...
(declaim (inline rassq))
(defun rassq (item a-list)
  "rassq                                  関数[#!subr]
...
(declaim (inline rassql))
(defun rassql (item a-list)
  "rassql                                 関数[#!subr]
...
(declaim (inline rassqu))
(defun rassqu (item a-list)
  "rassqu                                 関数[#!subr]
...
(defun readl (&optional (stream *standard-input*) (package *package*))
  "readl                                  関数[#!subr]
...
(declaim (inline readline))
(defun readline (&optional (stream *standard-input*) (package *package*))
  "readline                               関数[#!subr]
...
<例>
  ...
  (readl stream package))

(declaim (inline readline-to-string))
(defun readline-to-string (&optional stream)
...
(declaim (inline reads))
(defun reads (&optional stream)
  "reads                                  関数[#!subr]
...
(declaim (inline rem))
(defun rem (pred object list &optional n)
  "tao:rem                                関数[#!macro]
...
(declaim (inline remql))
(defun remql (item list &optional n)
  "remql                                  関数[#!macro]
...
(declaim (inline remqu))
(defun remqu (item list &optional n)
  "remqu                                  関数[#!macro]
