...
(defmacro ifundef (object1 object2)
  `(if (and ,object1 
            (symbolp ',object1))
       ,object1
       ,object2))
...
(defmacro image-can (var list &body forms)
  "image-can                              関数[#!macro]
...
(defmacro imagen (&body binds-and-form)
  "imagen                                 関数[#!macro]
...
(defun intersectionq (list1 &rest lists)
  "<説明>
